...
<body>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary">MAFIA TRILOGY</h2>
        </div>
        <div class="row tm-mb-90">            
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
                <img src="img/01-9-1.jpg" alt="Image" class="img-fluid">
          </div>
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
                    <p class="mb-4">
                     Mafia: Trilogy ประกาศเปิดตัวออกมาอย่างเป็นทางการแล้วว่ามันจะเป็นการนำเอาเกมในซีรีส์ Mafia กลับมาวางจำหน่ายอีกครั้งให้กับเครื่อง PlayStation 4, Xbox One และ PC และในการกลับมาในครั้งนี้ทางทีมพัฒนายังได้มีการรีเมคเกมภาคแรกใหม่ทั้งหมดอีกด้วย
                  </p>
                    <div class="text-center mb-5">
                        <a href="https://store.steampowered.com/agecheck/sub/465030#" class="btn btn-primary tm-btn-big">Download</a>
                    </div>
<div class="mb-4">
  <p>DEVELOPER: Hangar 13, D3T, Aspyr (Mac) PUBLISHER: 2K, Aspyr (Mac)&nbsp;</p>
  <p>FRANCHISE: Mafia&nbsp;</p>
  <p>RELEASE DATE: 25 Sep, 2020</p>
<p>&nbsp;</p>
</div>
