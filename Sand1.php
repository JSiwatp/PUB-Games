...
<head>
    ...
    <title>Blacksmith of the Sand Kingdom</title>
...
<body>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary">Blacksmith of the Sand Kingdom</h2>
        </div>
        <div class="row tm-mb-90">            
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
                <img src="img/02-2-2.png" alt="Image" class="img-fluid">
          </div>
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
                    <p class="mb-4">
                  มาเป็นช่างตีเหล็กในศาลที่ผจญภัยในอาณาจักรทรายในเกม RPG แฟนตาซี!</p>
                    <div class="text-center mb-5">
                        <a href="https://store.steampowered.com/app/1509820/Cloud_Climber/ " class="btn btn-primary tm-btn-big">Download</a>
                    </div>
<div class="mb-4">
  <p>RELEASE DATE: 7 Jan, 2021&nbsp;</p>
  <p>DEVELOPER: Rideon,Inc.&nbsp;</p>
  <p>PUBLISHER: KEMCO</p>
</div>
                    <div>
                        <h3 class="tm-text-gray-dark mb-3">Tags</h3>
                        <a href="index11.html" class="tm-text-primary mr-4 mb-2 d-inline-block">Action&nbsp;</a>
                        <a href="index21.html" class="tm-text-primary mr-4 mb-2 d-inline-block">Casual&nbsp;</a>
                        <a href="index31.html" class="tm-text-primary mr-4 mb-2 d-inline-block">Adventers&nbsp;</a>
                    </div>
                </div>
            </div>
        </div>
