...
<body>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary">Blackwake</h2>
        </div>
        <div class="row tm-mb-90">            
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
                <img src="img/01-12-1.jpg" alt="Image" class="img-fluid">
          </div>
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
                    <p class="mb-4">
                      Blackwake เกมแนว Online FPS ที่จะให้ผู้เล่นสวมบทเป็นโจรสลัดออกปล้นสะดมเหล่าเรือคนอื่น โดยผู้เล่นยังสามารถชวนเพื่อนมาร่วมภารกิจออกปล้นด้วยกันได้ และยังสามารถไปเจอเหล่าเรือผู้เล่นโจรสลัดคนอื่นได้อีกด้วย
                  </p>
                    <div class="text-center mb-5">
                        <a href="https://store.steampowered.com/app/420290/Blackwake/" class="btn btn-primary tm-btn-big">Download</a>
                    </div>
<div class="mb-4">
  <p>RELEASE DATE: 20 Feb, 2020&nbsp;</p>
  <p>DEVELOPER: Mastfire Studios Pty Ltd&nbsp;</p>
  <p>PUBLISHER: Mastfire Studios Pty Ltd</p>
<p>&nbsp;</p>
</div>
