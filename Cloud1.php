...
<body>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary">Cloud Climber</h2>
        </div>
        <div class="row tm-mb-90">            
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
                <img src="img/03-4-1.jpg" alt="Image" class="img-fluid">
          </div>
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
                    <p class="mb-4">
                  คนแรกที่เดินซิมเหนือจริงเกี่ยวกับจุดจบของมนุษยชาติ สำรวจซากปรักหักพังที่เชื่อมโยงกับท้องฟ้าอันงดงามและเรียนรู้ว่าเหตุใดจึงถูกสร้างขึ้น</p>
...
<div class="mb-4">
  ...
  <p>DEVELOPER: Two Star Games&nbsp;</p>
  <p>PUBLISHER: Two Star Games&nbsp;</p>
</div>
