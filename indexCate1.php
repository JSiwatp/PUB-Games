    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <a class="navbar-brand" href="index1.php">
                ...
                &nbsp; Welcome <?php echo $_SESSION['name'];?> to Pub-Game
            </a>
    ...
    <div class="tm-hero d-flex justify-content-center align-items-center" data-parallax="scroll" data-image-src="img/hero.jpg">
	    ...
	    <div class="container-fluid tm-container-content tm-mt-60">
			...
			<div class="row mb-4 align-center">
           	  <blockquote>
           	    <h1 class="col-6 tm-text-primary"> <strong> หมวดหมู่ </strong></h1>
       	      </blockquote>
            </div>
        ...
        <div class="row tm-mb-90 tm-gallery">
            ...
            <div class="col-12 d-flex justify-content-between align-items-center tm-paging-col">
                <a href="index - MN1.php" class="btn btn-primary tm-btn-next">ดูข่าวเพิ่มเติม</a>
            </div>            
        </div>
			...
			<div class="row tm-mb-90">
				<div class="col-12 d-flex justify-content-between align-items-center tm-paging-col">            
					<a href="index - MG1.php" class="btn btn-primary tm-btn-next">ดูเกมส์เพิ่มเติม</a>
				</div>            
      		</div>
        ...
        <div class="row tm-mb-90 tm-gallery">
			...
			<div class="row tm-mb-90">
				<div class="col-12 d-flex justify-content-between align-items-center tm-paging-col">            
					<a href="Act1.php" class="btn btn-primary tm-btn-next">ดูเกมส์เพิ่มเติม</a>
				</div>            
      		</div>
        ...
        <div class="row tm-mb-90 tm-gallery">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
                <figure class="effect-ming tm-video-item">
                    <img src="img/02-3.jpg" alt="Image" class="img-fluid">
                    <figcaption class="d-flex align-items-center justify-content-center">
						<h2>Sunlight</h2>
         	  		 <a href="Sunlight1.php">view more</a>
         	 			</figcaption>                    
                		</figure>
					<div class="d-flex justify-content-between tm-text-gray">
                    <span><strong>Sunlight</strong></span>
                </div>
			</div>
			...
			<div class="row tm-mb-90">
				<div class="col-12 d-flex justify-content-between align-items-center tm-paging-col">            
					<a href="Adventers1.php" class="btn btn-primary tm-btn-next">ดูเกมส์เพิ่มเติม</a>
				</div>            
      		</div>
		  ...
		  <div class="row mb-4">
			...
			<div class="row tm-mb-90">
            <div class="col-12 d-flex justify-content-between align-items-center tm-paging-col">
                <a href="Casual1.php" class="btn btn-primary tm-btn-next">ดูเกมส์เพิ่มเติม</a>
            </div>            
        </div>
