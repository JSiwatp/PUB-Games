...
<head>
    ...
    <title>Neil Druckmann บอกใบ้ถึงโปรเจกต์ใหม่ของ Naughty Dog</title>
...
<body>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary">Neil Druckmann บอกใบ้ถึงโปรเจกต์ใหม่ของ Naughty Dog ผ่านประกาศรับสมัครงานของบริษัท</h2>
        </div>
        <div class="row tm-mb-90">            
            ...
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
						...
						<h3 class="tm-text-gray-dark mb-3">Neil Druckmann ที่ขณะนี้ดำรงตำแหน่งเป็นประธานร่วมของบริษัท Naughty Dog ได้ออกมาบอกใบ้ถึงโปรเจกต์ใหม่ล่าสุด <a href=" https://t.co/ZGU6W3cAKU" target="_game" rel="stream">ผ่านทางประกาศรับสมัครงานแล้ว</a></h3>
						<p>&nbsp;&nbsp;เขาไม่ได้บอกอะไรมากไปกว่านี้ และตำแหน่งที่เปิดรับสมัครก็มีเยอะจนเดาอะไรได้ยาก <a href="https://www.gamesradar.com/neil-druckmann-teases-new-project-and-shares-naughty-dog-job-openings/" target="_game" rel="stream"> แต่สื่ออย่าง Gamesradar</a> ก็วิเคราะห์ว่าจากที่มีการรับสมัคร Level / Environment Designer และระบุต่อท้ายว่า “Single Player” ก็น่าจะมีแนวโน้มว่าพวกเขาอาจไม่ได้กำลังมุ่งเป้าจะทำโหมด Multiplayer ของ The Last of Us 2 อยู่จริง ๆ<br><br>

							สำหรับตำแหน่งเปิดรับที่น่าสนใจ มีดังนี้:<br>
							&emsp;&lt;Gameplay Animator&gt;<br>
							&emsp;&lt;Character Concept Artist&gt;<br>
							&emsp;&lt;Cinematic Lighting Artist&gt;<br>
							&emsp;&lt;Video Editor&gt;<br>
							&emsp;&lt;Game Designer&gt;<br>
							&emsp;&lt;Q/A Tester&gt;<br>
							&emsp;&lt;Producer&gt;<br>
							&emsp;&lt;Associate Producer&gt;<br>
							&emsp;&lt;UI Scripter&gt;<br>
							ทั้งนี้แล้ว หากมีความเคลื่อนไหวเกี่ยวกับผลงานใหม่ของสตูดิโอนี้ออกมาเพิ่มเติม เราจะนำมารายงานกันต่อไป
                    </p>
