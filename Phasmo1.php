...
<body>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary">Phasmophobia</h2>
        </div>
        <div class="row tm-mb-90">            
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
                <img src="img/01-44.jpg" alt="Image" class="img-fluid">
            </div>
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
                    <p class="mb-4">
                      เป็นกระแสฮือฮาในหมู่เกมเมอร์สุด ๆ ในขณะนี้กับ “Phasmophobia” ที่แปลว่าอาการกลัวผี เกมแนว Ghost Hunting Simulator ที่จะให้ผู้เล่นได้สวมบทบาทเป็นนักล่าท้าผียังกับรายการคนอวดผี หลายต่อหลายคนที่ได้เข้าไปเล่นต่างพูดเป็นเสียงเดียวกันว่าเกมอะไรกันวะเนี่ย ทำไมมันหลอนได้ขนาดนี้ ทำให้มีผู้เล่นหน้าใหม่จำนวนมากอยากจะเข้าไปลองของกัน วันนี้ก็จะขอมาวิเคราะห์รีวิวกันสักหน่อยว่ามันจะหลอนขนาดนั้นจริงหรือเปล่า !!
                  </p>
                    <div class="text-center mb-5">
                        <a href="https://store.steampowered.com/app/739630/Phasmophobia/" class="btn btn-primary tm-btn-big">Download</a>
                    </div>
<div class="mb-4">
  <p>RELEASE DATE: 19 Sep, 2020&nbsp;</p>
  <p>DEVELOPER: Kinetic Games&nbsp;</p>
  <p>PUBLISHER: Kinetic Games</p>
<p>&nbsp;</p>
</div>
