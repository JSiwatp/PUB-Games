...
<head>
    ...
    <title>Darksiders Genesis</title>
...
<body>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary">Darksiders Genesis</h2>
        </div>
        <div class="row tm-mb-90">            
            ...
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
                    <p class="mb-4">
                      Darksiders Genesis เป็นเกมแนว Action RPG ที่มีเนื้อหาออกแนวดาร์กแฟนตาซีจากทีมพัฒนา Airship Syndicate เนื้อเรื่องเข้มข้นน่าติดตามโดย 3 ภาคก่อนหน้านี้จะนำเสนอภาพในมุมมองบุคคลที่ 3 แต่สำหรับตัวเกมภาคใหม่นี้ฉีกแหวกแนวขอนำเสนอในรูปแบบภาคมุมมองด้านบนสไตล์ Diablo และที่สำคัญตัวเกม Darksiders Genesis ภาคนี้ยังมีฟังก์ชั่นรอบรับการเล่นในรูปแบบ Co-op เป็นครั้งแรกของซีรีส์นี้อีกด้วยงานนี้ไม่ต้องเล่นอย่างเหงาๆ อีกต่อไป
                  </p>
                    <div class="text-center mb-5">
                        <a href="https://store.steampowered.com/app/710920/Darksiders_Genesis/" class="btn btn-primary tm-btn-big">Download</a>
                    </div>
<div class="mb-4">
  <p>RELEASE DATE: 6 Dec, 2019&nbsp;</p>
  <p>DEVELOPER: Airship Syndicate&nbsp;</p>
