...
<body>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary">Down in Bermuda</h2>
        </div>
        <div class="row tm-mb-90">            
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
                <img src="img/02-1-1.jpg" alt="Image" class="img-fluid">
          </div>
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class=" tm-bg-gray tm-video-details">
                    <p class="mb-4 align-center">
                  พายุที่ผิดธรรมชาติทำให้นักบินผจญภัยติดอยู่ในเบอร์มิวดาที่น่าอับอายมานานหลายทศวรรษ เอาชนะสิ่งมีชีวิตที่อยู่ลึกและไขความลับของเกาะเพื่อค้นหาทางกลับบ้าน</p>
                    <div class="text-center mb-5">
                        <a href="https://store.steampowered.com/app/1107300/Down_in_Bermuda/ " class="btn btn-primary tm-btn-big">Download</a>
                    </div>
<div class="mb-4">
  <p>RELEASE DATE: 14 Jan, 2021&nbsp;</p>
  <p>DEVELOPER: Yak &amp; Co&nbsp;</p>
  <p>PUBLISHER: Yak &amp; Co&nbsp;</p>
</div>
