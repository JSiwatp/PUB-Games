...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
				...
				<li class="nav-item">
                    <a class="nav-link nav-link-4" href="login.php">เข้าสู่ระบบ</a>
                </li>
            </ul>
            </div>
        </div>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary">Leaf Blower Revolution - Idle Game</h2>
        </div>
        <div class="row tm-mb-90">            
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
                <img src="img/03-3-1.jpg" alt="Image" class="img-fluid">
          </div>
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
                    <p class="mb-4">
                  Leaf Blower Revolution เป็นเกมที่เล่นฟรีโดยไม่ได้ใช้งานที่คุณเป่าใบไม้ด้วยเครื่องเป่าใบไม้นิวเคลียร์ปลดล็อคการอัพเกรดรับรางวัลพิเศษและอื่น ๆ อีกมากมาย ลอง Leaf Blower Revolution ตอนนี้และดูตัวเลขที่เพิ่มขึ้น!</p>
                    <div class="text-center mb-5">
                        <a href="https://store.steampowered.com/app/1468260/Leaf_Blower_Revolution__Idle_Game/ " class="btn btn-primary tm-btn-big">Download</a>
                    </div>
<div class="mb-4">
  <p>RELEASE DATE: 4 Dec, 2020&nbsp;</p>
  <p>DEVELOPER: Humble North&nbsp;</p>
  <p>PUBLISHER: Humble North</p>
</div>
