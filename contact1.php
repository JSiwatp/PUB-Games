    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-4 active" aria-current="page" href="contact.html">ติดต่อAdmin</a>
                </li>
				<li class="nav-item">
            ...
            <div class="col-12 mb-5">
                ...
                <form id="contact-form" action="" method="POST" class="tm-contact-form mx-auto">
                    <div class="form-group">
                        <input type="text" value=<?php  echo $_SESSION['name'];?> name="name" class="form-control rounded-0" placeholder="Name" required />
                    </div>
                    <div class="form-group">
                        <input type="email"  value=<?php  echo $_SESSION['email'];?> name="email" class="form-control rounded-0" placeholder="Email" required />
                    </div>
