...
<head>
    ...
    <title>Playerunknow's Battlegrounds</title>
...
<body>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary">PLAYERUNKNOWN'S BATTLEGROUNDS</h2>
        </div>
        <div class="row tm-mb-90">            
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
                <img src="img/01-8-1.jpg" alt="Image" class="img-fluid">
          </div>
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
                    <p class="mb-4">
                      สำหรับโลกของเกมเมอร์ชาว PC ในตอนนี้คงไม่มีเกมไหนร้อนแรงเท่ากับเกมนี้ “เพลยเยอร์อันโน แบทเทิ่ลกราวน์” ที่เพิ่งจะประกาศลงเครื่อง Xbox One ไปบนเวทีแถลงข่าวของไมโครซอฟต์เมื่อ E3 ที่ผ่านมา มันคือเกมสไตล์ Battle Royale ที่จับเอาผู้เล่น 100 คน มาปล่อยบนเกาะรกร้างห่างไกล ให้เอาตัวรอดโดยการหาอาวุธ- อุปกรณ์ มาใช้ห้ำหั่นกัน จนเหลือผู้รอดชีวิตคนสุดท้ายเพียงหนึ่งเดียวที่จะเป็นผู้ชนะ คอนเซปต์ของเกมได้แรงบันดาลใจมาจากลภาพยนต์ชื่อดังอย่าง Battle Royale และ Hunger Game ซึ่งเมื่อนำมาออกมาทำเป็นวีดีโอเกมแล้วก็สนุกอย่างไม่น่าเชื่อ
                  </p>
                    <div class="text-center mb-5">
                        <a href="https://store.steampowered.com/app/1118010/Monster_Hunter_World_Iceborne/" class="btn btn-primary tm-btn-big">Download</a>
                    </div>
<div class="mb-4">
  <p>RELEASE DATE: 21 Dec, 2017&nbsp;</p>
  <p>DEVELOPER: KRAFTON, Inc.&nbsp;</p>
  <p>PUBLISHER: KRAFTON, Inc.&nbsp;</p>
<p>&nbsp;</p>
</div>
